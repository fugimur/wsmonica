...
public class Musica {
	...
	@Temporal(TemporalType.DATE)  // especifica o tipo, se DATA, HORA ou DATAeHORA
	@JsonFormat(pattern="dd/MM/yyyy", shape=JsonFormat.Shape.STRING)
	private Date cadastro;
	
	@Column(name="lancamento")
	private int lancamento;  // 0 para não lancamento e 1 para lancamento
	
	@ManyToOne
	@JsonIgnoreProperties("musicas")  // ignora para nao entrar em looping na pesquisa de musicas
